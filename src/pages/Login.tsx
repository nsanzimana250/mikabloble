        ...
        <div className="section-container w-full max-w-md mx-auto">
          ...
          >
            <div className="text-center mb-8">
              ...
              <h1 className="font-display font-bold text-2xl text-foreground">{t("auth.welcomeBack")}</h1>
              <p className="text-muted-foreground text-sm mt-1">{t("auth.welcomeBackDesc")}</p>
            </div>
            ...
            <p className="text-center text-sm text-muted-foreground mt-6">
              {t("auth.noAccount")}{" "}
              <Link to="/signup" className="text-secondary font-semibold hover:underline">{t("auth.createAccount")}</Link>
            </p>
          </motion.div>
        </div>
      </section>
